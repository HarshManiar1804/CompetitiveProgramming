...
void solve()
{
    ll a, b, sum1 = 0, sum2 = 0, sum = 0, sum4 = 0;
    string str, str2, str3, x = "", y = "", ans = "";
    cin >> a >> b;
    sum1 = a + b;
    str = to_string(sum1), str2 = to_string(a), str3 = to_string(b);
    ...
    ll X = stringToInt(x);
    ll Y = stringToInt(y);
    ll Ans = stringToInt(ans);
    ll check = X + Y;
    // cout << ans << " " << Ans << " " << check;
    cout << (check == Ans ? "YES" : "NO");
}
int main()
{
    ll t = 1;
