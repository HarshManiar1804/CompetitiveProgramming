...
int main()
{
    ...
    ll count=minFunForThree(two,five,six)*256;
    ll checkTwo=(two-minFunForThree(two,five,six));

    if(checkTwo ==0)
        count+=(two-minFunForThree(two,five,six))*32;
    else if(checkTwo>0)
        count+=min(checkTwo,three)*32;
